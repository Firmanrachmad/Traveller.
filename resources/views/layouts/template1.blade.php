...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('admins/assets/plugins/chartist/dist/chartist.min.css') }}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{ asset('admins/monster-html/css/style.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ asset('admins/assets/plugins/jquery/dist/jquery.min.js') }}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('admins/assets/plugins/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('admins/monster-html/js/app-style-switcher.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('admins/monster-html/js/waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('admins/monster-html/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('admins/monster-html/js/custom.js') }}"></script>
    <!--This page JavaScript -->
    <!--flot chart-->
    <script src="{{ asset('admins/assets/plugins/flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('admins/assets/plugins/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('admins/monster-html/js/pages/dashboards/dashboard1.js') }}"></script>
</body>
